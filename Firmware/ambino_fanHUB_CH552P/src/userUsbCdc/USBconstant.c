...
__xdata uint16_t DevDescLen = sizeof(DevDesc);

__xdata uint8_t CfgDesc[] ={
...
__xdata uint16_t CfgDescLen = sizeof(CfgDesc);

//String Descriptors
__xdata uint8_t LangDes[]={0x04,0x03,0x09,0x04};           //Language Descriptor
__xdata uint16_t LangDesLen = sizeof(LangDes);
// __code uint8_t SerDes[]={                                 //Serial String Descriptor
//     0x0C,0x03,
//     '1',0x00,'2',0x00,'3',0x00,'4',0x00,'5',0x00
// };
// __code uint16_t SerDesLen = sizeof(SerDes);

__xdata uint8_t Prod_Des[]={                                //Produce String Descriptor
0x1C,0x03,
    'A',0x00,'m',0x00,'b',0x00,'i',0x00,'n',0x00,'o',0x00,' ',0x00,
    'F',0x00,'a',0x00,'n',0x00,'H',0x00,'u',0x00,'b',0x00
};
__xdata uint16_t Prod_DesLen = sizeof(Prod_Des);

__xdata uint8_t CDC_Des[]={                            
    0x16,0x03,
    'C',0x00,'D',0x00,'C',0x00,' ',0x00,'S',0x00,'e',0x00,
    'r',0x00,'i',0x00,'a',0x00,'l',0x00
};
__xdata uint16_t CDC_DesLen = sizeof(CDC_Des);

__xdata uint8_t Manuf_Des[]={
    0x0E,0x03,
    'A',0x00,'m',0x00,'b',0x00,'i',0x00,'n',0x00,'o',0x00,
};
__xdata uint16_t Manuf_DesLen = sizeof(Manuf_Des);
